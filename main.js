...
var jsondata =  {
   ...
   },
   {
     ...
     "user":"lealucia",
     "name":"Bamberg ",
     "wikipedia":"https://de.wikipedia.org/wiki/Bamberg Etappenseite:  https://github.com/lealucia "
     }
   }
 ]
 };
 ...
 L.geoJSON(jsondata, {}).bindPopup(function (layer) {
    ...
    <ul> 
        ...
        <li><a href="https://${prop.user}.github.io/top">Etappenseite</a></li>
        <li><a href="${prop.wikipedia}">Wikipediaseite</a></li>
    </ul>
`;
}).addTo(map);
